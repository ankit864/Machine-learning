...
Sys.setenv(tz = "UTC")
sp500 <- getYahooData("^GSPC", start = 19500101, end = 20120909, freq = "daily",  type = "price",adjust = TRUE, quiet = FALSE)
#If this doesn't work. Open IE and open yahoo finance, the set it as a trusted website in "Internet Options".
head(sp500)
tail(sp500)
